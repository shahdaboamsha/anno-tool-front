...
export default function UploadFileFormStepper({ activeStep }) {
    ...
    return (
        <div >
            <div style={{backgroundColor: 'inherit'}} className={activeStep == 0 ? "flex flex-column-items padding-8px bg-white" : "hidden"}>
            ...
            <div style={{backgroundColor: 'inherit'}} className={activeStep == 1 ? "flex flex-column-items padding-8px bg-white" : "hidden"}>
            ...
            <div className={activeStep == 1 ? "margin-30px-top flex flex-centered-items" : "hidden"}>
                <Button
                    variant='contained'
                    size='large'
                    fullWidth
