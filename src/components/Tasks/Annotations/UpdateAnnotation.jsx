...
export default function UpdateAnnotation({ sentence, task, notifyChanges, closeDialog }) {

    const navigate = useNavigate()
    const [selectedLabel, setSelectedLabel] = useState(sentence.label)
