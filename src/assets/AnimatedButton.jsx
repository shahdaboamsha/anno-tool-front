    ...
    return (
        <>
            <div className="group relative flex justify-center items-center text-zinc-600 text-sm font-bold">
                ...
                <div
                    classNameName="shadow-md flex items-center group-hover:gap-2 bg-gradient-to-br from-lime-200 to-yellow-200 p-3 rounded-full cursor-pointer duration-300"
                >
                    <svg
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    >
                        ...
                        ></path></svg
                    ><span classNameName="text-[0px] group-hover:text-sm duration-300"
